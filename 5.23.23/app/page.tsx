// site: https://flowbite.com/docs/components/navbar/
function NavBar({ logoSrcUrl, logoHref, title } ) {
    return (
        <nav className="bg-white border-gray-200 dark:bg-gray-900">
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href={logoHref ? logoHref : "https://flowbite.com/"} className="flex items-center">
                <img src={logoSrcUrl ? logoSrcUrl : "https://flowbite.com/docs/images/logo.svg"} className="h-8 mr-3" alt="Flowbite Logo" />
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">{title ? title : ""}</span>
            </a>
...
export default function Page() {
    return ( <div>
        ...
        <NavBar logoSrcUrl="https://upload.wikimedia.org/wikipedia/commons/2/2f/Google_2015_logo.svg" 
        logoHref="https://www.google.com/" 
        title={""}
        />
        <div className="items-center">
        <h1 className="text-3xl font-bold underline self-center">Hello, Next.js!</h1>
        </div>
